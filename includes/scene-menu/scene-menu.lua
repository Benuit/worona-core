	...
	local menu_items_table = worona:do_filter( "filter_menu_list_items_table",
		{
			...
			},
			{
				...
				action = {
					name = "load_url",
					params = { url = "https://mobile.twitter.com/unomasunomx", effect = "slideLeft", time = 200 }
				}
			},
			{
				text = "Facebook",
				action = {
					name = "load_url",
					params = { url = "https://m.facebook.com/unomasuno.com.mx/", effect = "slideLeft", time = 200 }
				}
			},
			{
				text = "Youtube",
				action = {
					name = "load_url",
					params = { url = "https://m.youtube.com/channel/UCTaKdyTeBFibaPvTAkbKluQ", effect = "slideLeft", time = 200 }
				}
			},
			{
				text = "UTV",
				action = {
					name = "load_url",
					params = { url = "http://www.unomasuno.com.mx/utv/", effect = "slideLeft", time = 200 }
				}
			},
			{
				text = "Edicion Digital",
				action = {
					name = "load_url",
					params = { url = "https://issuu.com/unomasuno/docs/", effect = "slideLeft", time = 200 }
				}
			}
		}
	)
